...
public class Lecture {
    ...
    */
    ...
    // name of the method -= returnNotOne
    ...
    */
    ...
    /*
    17. Cigar Parties are all the rage among squirrels.  Sammy the Squirrel has asked you to write a method to
        determine if a party is a success.
        A party will be a success if the ratio of cigars to squirrels is at least 2 cigars per squirrel
        cigars / squirrels
     */
    public boolean isCigarPartySuccess(int cigars, int squirrels){
        double cigarsPerSquirrels = (double)cigars / squirrels;
        if (cigarsPerSquirrels >= 2){
            return true;
        }
        return false;
    }
    ...
    /*
    18.  Sammy forgot to take into account that during the week the ratio of at least 2 cigars per squirrel
         is a successful party, but on the weekends, a successful party needs a ratio of at least 2.75 cigars
         per squirrel.  Modify the method to take into account if it is a weekend
     */
    public boolean isCigarPartySuccess(int cigars, int squirrels, boolean weekend) {
        double cigarsPerSquirrels = (double)cigars / squirrels;
        if (cigarsPerSquirrels >= 2 && !weekend){  // a weekday party
            return true;
        }
        if (cigarsPerSquirrels >= 2.75 && weekend){ // a weekend party
            return true;
        }
        return false;
    }
    ...
    /*
    19.  Susie needs a method to analyze data on squirrel cigar parties based on an average of number of
         cigars consumed by 4 different squirrels.
         Write a method to calculate this average
     */
    public double averageCigarConsumption(int squirrel1Cigars, int squirrel2Cigars,
                                          int squirrel3Cigars, int squirrel4Cigars ) {
        int totalCigars = squirrel1Cigars + squirrel2Cigars + squirrel3Cigars + squirrel4Cigars;
        double average = (double)totalCigars / 4; // INTEGER MATH!!!
        return average;
    }
