...
public class LectureTest {
    ...
    @Test
    public void testIsCigarPartySuccess() {
        assertTrue(exercises.isCigarPartySuccess(4, 2));
        assertTrue(exercises.isCigarPartySuccess(5, 2));
        assertFalse(exercises.isCigarPartySuccess(2, 2));
        assertFalse(exercises.isCigarPartySuccess(2, 10));
    }

    @Test
    public void testIsCigarPartyWeekendSuccess() {
        assertTrue(exercises.isCigarPartySuccess(4, 2, false));
        assertTrue(exercises.isCigarPartySuccess(6, 2, true));
        assertFalse(exercises.isCigarPartySuccess(4, 2, true));
        assertFalse(exercises.isCigarPartySuccess(2, 10, false));
    }

    @Test
    public void testAverageCigarConsumption() {
        assertEquals(2.0, exercises.averageCigarConsumption(2, 1, 3, 2), 0.001);
        assertEquals(4.25, exercises.averageCigarConsumption(6, 2, 5, 4), 0.001);
        assertEquals(1.25, exercises.averageCigarConsumption(1, 1, 2, 1), 0.001);
        assertEquals(3.0, exercises.averageCigarConsumption(2, 2, 3, 5), 0.001);
    }
