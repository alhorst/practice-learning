...
public class App {
    ...
    private void run() {
        ...
        while (menuSelection != 0) {
            ...
            if (menuSelection == 1) {
                Hotel[] hotelArray = hotelService.listHotels();
                consoleService.printHotels(hotelArray);
            } else if (menuSelection == 2) {
                Review[] reviewArray = hotelService.listReviews();
                consoleService.printReviews(reviewArray);
