...
INSERT INTO hotel (name, address_id, stars, rooms_available, cost_per_night, cover_img) VALUES ('GreektownDetroit', 7, 5, 77, 159.00, 'default-cover-image.png');
...
INSERT INTO reservation (hotel_id, full_name, check_in_date, check_out_date, guests) VALUES (1, 'John Smith', NOW(), now() + interval '3 days', 2);
INSERT INTO reservation (hotel_id, full_name, check_in_date, check_out_date, guests) VALUES (1, 'Sam Turner', NOW() + interval '5 days', now() + interval '10 days', 4);
INSERT INTO reservation (hotel_id, full_name, check_in_date, check_out_date, guests) VALUES (1, 'Mark Johnson', NOW() + interval '7 days', now() + interval '10 days', 2);
