...
function displayReviews() {
  ...
  reviews.forEach((review) => {
    ...
    // add review as the class
    container.setAttribute('class', 'review');
    // call each method -- send the container and the content 
    ...
    // add element to html (appendChild? insertAdjacentElement)
...
function addRating(parent, numberOfStars) {
  ...
  //loop through how many numberOfStars I need to display
