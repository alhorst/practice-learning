...
document.addEventListener('DOMContentLoaded', () => {
  ...
  // add event handling for toggle of the event description
  // when the user clicks on the description, show the input box
  ...
  addReview.addEventListener('click', showHideForm);
 ...
 */
function saveReview() {
  // connect to all the input boxes in the form
  const name = document.getElementById('name');
  // name, title, rating, review
  const title = document.getElementById('title');
  const rating = document.getElementById('rating');
  const review = document.getElementById('review');
  // create a new review object loaded with the form's content
  const newReview = {
    reviewer: name.value,
    title: title.value,
    rating: rating.value,
  ...
  // push the new review object on the array called reviews
