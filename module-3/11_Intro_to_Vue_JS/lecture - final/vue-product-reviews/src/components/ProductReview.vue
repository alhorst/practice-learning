<template>
  <div class="main">
    ...
    <!-- boxes to hold how many of each rating of reviews we have -->
    <!-- plus a box for average  -->
    ...
    <!-- actual reviews being displayed -->
    <div
      class="review"
...
export default {
  ...
  computed: {
    ...
    numberOfFourStarReviews() {
      ...
      }, 0); // trailing 0 says initialize or start currentCount at 0
      return count;
    },
