...
export default {
  ...
  computed: {
    filteredReviews() {
      return this.reviews.filter((review) => {
        if (this.filter === 0) {
          // return all the reviews for 0
          return true;
        } else {
          // otherwise loop through matching this.filter
          // return the review if the filter rating === review.rating
  ...
  methods: {
    addNewReview() {
      // this.reviews is the array in the data section
      // unshift says add to the front of the array
      // this.newReview is also in the data section
      // this allows us access to 'stuff' in the data section
